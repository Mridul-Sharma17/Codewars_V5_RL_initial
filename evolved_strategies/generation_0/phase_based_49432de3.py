...
team_name = "Phase Based 0352"
troops = [Troops.skeleton, Troops.knight, Troops.archer, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.prince, Troops.wizard]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.35227241212091176,
        'elixir_threshold': 9.761683636828383,
        'deploy_distance': 15.08109694948386,
        'troop_preferences': {
            'cheap': 1.9239563242828137,
            'medium': 1.078413104828075,
            'expensive': 0.38257233454701123,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.4953281429694524,
        'elixir_threshold': 6.6410972114916,
        'deploy_distance': 11.285374677877371,
        'troop_preferences': {
            'cheap': 0.7199024010551789,
            'medium': 1.56399208734417,
            'expensive': 1.4156703410212557,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.8722031965207429,
        'elixir_threshold': 2.2129954215165406,
        'deploy_distance': 3.036806745856948,
        'troop_preferences': {
            'cheap': 0.885809194997782,
            'medium': 1.1656955069065993,
            'expensive': 1.7995222805933273,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
