...
team_name = "Phase Based 23db"
troops = [Troops.archer, Troops.knight, Troops.minion, Troops.musketeer, Troops.valkyrie, Troops.dragon, Troops.prince, Troops.wizard]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.26859809964856685,
        'elixir_threshold': 8.802876493464165,
        'deploy_distance': 18.563199190241907,
        'troop_preferences': {
            'cheap': 2.8379922181013613,
            'medium': 1.0102519818484987,
            'expensive': 0.696633008472035,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.564899425257062,
        'elixir_threshold': 5.616609931855191,
        'deploy_distance': 6.102305071191853,
        'troop_preferences': {
            'cheap': 1.2527371475474691,
            'medium': 1.3802411456078785,
            'expensive': 1.04583639449233,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.6310659960542602,
        'elixir_threshold': 3.5447700749877367,
        'deploy_distance': 4.714220132686091,
        'troop_preferences': {
            'cheap': 0.8218896195222698,
            'medium': 1.0181698967533563,
            'expensive': 1.0237369643949537,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
