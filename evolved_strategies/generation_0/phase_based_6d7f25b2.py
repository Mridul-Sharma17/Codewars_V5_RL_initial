...
team_name = "Phase Based 4ad1"
troops = [Troops.skeleton, Troops.knight, Troops.archer, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.prince, Troops.giant]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.1833841613602737,
        'elixir_threshold': 9.153046198354605,
        'deploy_distance': 14.158820410066864,
        'troop_preferences': {
            'cheap': 1.0008340490779457,
            'medium': 1.306689614322137,
            'expensive': 0.7824072024616551,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.6404565032782967,
        'elixir_threshold': 5.302709914287616,
        'deploy_distance': 8.555576083238675,
        'troop_preferences': {
            'cheap': 1.3610234255331322,
            'medium': 1.4807106881443262,
            'expensive': 1.0309931842418318,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.7616327829992947,
        'elixir_threshold': 2.5894989404094684,
        'deploy_distance': 9.301789165727625,
        'troop_preferences': {
            'cheap': 0.4463906493363274,
            'medium': 1.322824524980006,
            'expensive': 1.1607677038593132,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
