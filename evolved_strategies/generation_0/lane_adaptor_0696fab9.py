...
team_name = "Lane Adaptor 5a5c"
troops = [Troops.prince, Troops.balloon, Troops.archer, Troops.musketeer, Troops.wizard, Troops.valkyrie, Troops.barbarian, Troops.skeleton]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 21.47704861628316,
    'lane_memory_factor': 0.6874692742610521,
    'lane_pressure_threshold': 0.49855902819513165,
    'defensive_distance': 10.879711205859474,
    'offensive_distance': 9.161604305689126,
    'grouping_factor': 0.7104637506115415,
    'counter_deploy_ratio': 0.8292948876276502,
    'troop_role_weights': {
        'tank': 1.6686135101901716,
        'support': 0.9580064653840958,
        'swarm': 0.845900913677057,
        'splasher': 1.037123116616062,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
