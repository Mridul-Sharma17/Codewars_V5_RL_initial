...
deploy_list = Troops([])
team_signal = "v:1,l:c,e:6.4919796370061364,d:0.8,y:32,t:dwvkm"
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 6.4919796370061364,  # Minimum elixir to deploy
        "defensive_trigger": 0.8141708160513312,  # Tower health % to switch to defensive
        "y_default": 32,  # Default y position
        "y_defensive": 24  # Defensive y position
    }
