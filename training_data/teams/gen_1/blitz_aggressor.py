...
deploy_list = Troops([])
team_signal = "v:1,l:f,e:2.2,d:0.3,y:48,t:vkdbm"

def random_x(min_val=-12, max_val=12):
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 2.2,  # Minimum elixir to deploy
        "defensive_trigger": 0.35,  # Tower health % to switch to defensive
        "y_default": 48,  # Default y position
        "y_defensive": 22  # Defensive y position
    }
