...
team_name = "Lane Adaptor cc60"
troops = [Troops.prince, Troops.balloon, Troops.musketeer, Troops.archer, Troops.wizard, Troops.dragon, Troops.skeleton, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 22.66080414650418,
    'lane_memory_factor': 0.6657913250035439,
    'lane_pressure_threshold': 0.46162130577502003,
    'defensive_distance': 11.594559299888003,
    'offensive_distance': 4.058330759700388,
    'grouping_factor': 0.427740582242117,
    'counter_deploy_ratio': 0.5780274233386147,
    'troop_role_weights': {
        'tank': 1.884352702620363,
        'support': 1.8097240710406965,
        'swarm': 1.4839081497333586,
        'splasher': 1.0384199488347976,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
