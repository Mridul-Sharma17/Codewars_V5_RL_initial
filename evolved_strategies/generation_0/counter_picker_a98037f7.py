...
params = {
    'counter_weights': {
        'air': 2.3292059241476055,
        'ground': 0.6116688152292145,
        'splash': 1.0395352625855332,
        'tank': 1.618915575899761,
        'swarm': 2.9039256436889267,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 6.837551036247407,
    'air_deploy_distance': 7.8036477433496545,
    'ground_deploy_distance': 13.423849614820426,
    'lane_preference': 14.78563169662251,
    'elixir_threshold': 6.728516848550597,
    'aggressive_threshold': 0.4612334266871143,
}
