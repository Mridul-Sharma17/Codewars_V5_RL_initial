...
team_name = "Resource Manager 0b71"
troops = [Troops.minion, Troops.archer, Troops.barbarian, Troops.musketeer, Troops.dragon, Troops.valkyrie, Troops.giant, Troops.prince]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 36,
    'mid_game_threshold': 106,
    'early_elixir_threshold': 6.226370784361457,
    'mid_elixir_threshold': 4.088108279184734,
    'late_elixir_threshold': 6.135252333519709,
    'elixir_advantage_threshold': 2.7842248493452506,
    'troop_value_coefficients': {
        'health': 0.01518899032802551,
        'damage': 0.6114788546861023,
        'speed': 0.9749142451701249,
        'attack_range': 0.29533694177913583,
        'splash_range': 2.058938636629822,
    },
    'deploy_distance': 6.2660892806976705,
    'spread_factor': 18.799104573195805,
    'lane_preference': 13.519764356465686,
}
