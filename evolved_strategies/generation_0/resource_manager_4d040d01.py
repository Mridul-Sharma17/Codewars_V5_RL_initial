...
team_name = "Resource Manager 20a0"
troops = [Troops.barbarian, Troops.archer, Troops.skeleton, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.wizard, Troops.giant]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 57,
    'mid_game_threshold': 111,
    'early_elixir_threshold': 7.637983427743497,
    'mid_elixir_threshold': 7.435710443935,
    'late_elixir_threshold': 5.254435943767503,
    'elixir_advantage_threshold': 2.42816102489973,
    'troop_value_coefficients': {
        'health': 0.01989469435086011,
        'damage': 0.74870965782325,
        'speed': 0.9073766800040928,
        'attack_range': 0.9084329250336585,
        'splash_range': 1.1514158526265308,
    },
    'deploy_distance': 16.801347068369218,
    'spread_factor': 7.416480374763448,
    'lane_preference': 11.25985864733877,
}
