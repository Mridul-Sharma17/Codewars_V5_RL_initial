...
deploy_list = Troops([])
team_signal = "v:1,l:b,e:6.5,d:0.8,y:20,t:wmvdk,c:1.8"

def random_x(min_val=-30, max_val=30):
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 6.5,  # Minimum elixir to deploy
        "defensive_trigger": 0.85,  # Tower health % to switch to defensive
        "y_default": 20,  # Default y position
        "y_defensive": 10  # Defensive y position
    }
