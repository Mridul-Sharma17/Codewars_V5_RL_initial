...
team_name = "Lane Adaptor 868b"
troops = [Troops.knight, Troops.giant, Troops.archer, Troops.musketeer, Troops.valkyrie, Troops.wizard, Troops.minion, Troops.barbarian]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 24.780170483281555,
    'lane_memory_factor': 0.7626159299696539,
    'lane_pressure_threshold': 0.7701930158311212,
    'defensive_distance': 19.358251765558407,
    'offensive_distance': 6.663438212904196,
    'grouping_factor': 0.19371007549596242,
    'counter_deploy_ratio': 1.1742020972193734,
    'troop_role_weights': {
        'tank': 1.4840530464934742,
        'support': 0.8328517882092437,
        'swarm': 0.711489040233569,
        'splasher': 1.0781339827771321,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
