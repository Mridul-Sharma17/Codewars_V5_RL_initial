...
team_name = "Phase Based 4ebf"
troops = [Troops.archer, Troops.knight, Troops.skeleton, Troops.valkyrie, Troops.musketeer, Troops.dragon, Troops.wizard, Troops.balloon]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.45110089003795606,
        'elixir_threshold': 7.848015867416825,
        'deploy_distance': 17.275904102542125,
        'troop_preferences': {
            'cheap': 2.34054741353939,
            'medium': 0.9562607658243034,
            'expensive': 0.35759546957071164,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.6426802272116565,
        'elixir_threshold': 4.688785172962016,
        'deploy_distance': 6.144328807299864,
        'troop_preferences': {
            'cheap': 1.213193460823288,
            'medium': 1.7396674358346056,
            'expensive': 0.9916533410829365,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.6287019939247553,
        'elixir_threshold': 3.2557226510228694,
        'deploy_distance': 3.9248512982456596,
        'troop_preferences': {
            'cheap': 0.7862822795527529,
            'medium': 1.4813169185452897,
            'expensive': 1.422650121122662,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
