...
team_name = "Phase Based a485"
troops = [Troops.archer, Troops.knight, Troops.minion, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.giant, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.24916583039354617,
        'elixir_threshold': 7.42957656718203,
        'deploy_distance': 19.27748345776034,
        'troop_preferences': {
            'cheap': 2.8581759395554163,
            'medium': 1.2288278858031425,
            'expensive': 0.2872575129701497,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.7146514372412562,
        'elixir_threshold': 6.609854950211496,
        'deploy_distance': 7.4312320929357325,
        'troop_preferences': {
            'cheap': 1.4907078751857912,
            'medium': 1.948515873751266,
            'expensive': 0.8969509883382554,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.7959975874788282,
        'elixir_threshold': 4.166159359495915,
        'deploy_distance': 1.700210835652498,
        'troop_preferences': {
            'cheap': 0.34508062331205824,
            'medium': 1.195240100119386,
            'expensive': 1.334698701181812,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
