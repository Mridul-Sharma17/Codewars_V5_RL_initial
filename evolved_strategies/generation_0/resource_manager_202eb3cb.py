...
team_name = "Resource Manager 556d"
troops = [Troops.minion, Troops.barbarian, Troops.archer, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.wizard, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_elixir_threshold': 7.88441528623271,
    'mid_elixir_threshold': 4.408606278930655,
    'late_elixir_threshold': 6.126342808004619,
    'elixir_advantage_threshold': 1.8147614298702086,
    'troop_value_coefficients': {
        'health': 0.07920382781040265,
        'damage': 0.8464849595387894,
        'speed': 0.9006890385957171,
        'attack_range': 0.715873251668097,
        'splash_range': 1.0370712558966806,
    },
    'deploy_distance': 14.781070625685189,
    'spread_factor': 11.233060294472626,
    'lane_preference': -3.3216634630998563,
}
