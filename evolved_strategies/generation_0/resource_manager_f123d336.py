...
team_name = "Resource Manager 85d3"
troops = [Troops.knight, Troops.barbarian, Troops.skeleton, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.balloon, Troops.wizard]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 44,
    'mid_game_threshold': 92,
    'early_elixir_threshold': 6.56883724990336,
    'mid_elixir_threshold': 6.527011873671734,
    'late_elixir_threshold': 6.529021141220809,
    'elixir_advantage_threshold': 2.0271076744728784,
    'troop_value_coefficients': {
        'health': 0.02671880305679407,
        'damage': 0.7834508634100067,
        'speed': 1.8557776433536721,
        'attack_range': 0.4652406436095866,
        'splash_range': 2.270383504864279,
    },
    'deploy_distance': 7.919527621266726,
    'spread_factor': 14.629743607928477,
    'lane_preference': 14.89434344026946,
}
