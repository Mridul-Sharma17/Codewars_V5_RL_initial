...
params = {
    'counter_weights': {
        'air': 1.7601048708036768,
        'ground': 0.5351009556392243,
        'splash': 2.6033577379763866,
        'tank': 0.9964648977978076,
        'swarm': 1.5123809173908005,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 11.49855201505224,
    'air_deploy_distance': 1.1172136820991363,
    'ground_deploy_distance': 13.186963150296277,
    'lane_preference': 1.9808612957323675,
    'elixir_threshold': 4.1341425126273545,
    'aggressive_threshold': 0.3574536848771545,
}
