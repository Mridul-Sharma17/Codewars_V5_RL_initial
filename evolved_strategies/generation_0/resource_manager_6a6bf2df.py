...
team_name = "Resource Manager c930"
troops = [Troops.barbarian, Troops.knight, Troops.archer, Troops.valkyrie, Troops.dragon, Troops.musketeer, Troops.wizard, Troops.balloon]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 59,
    'mid_game_threshold': 98,
    'early_elixir_threshold': 8.814260485037615,
    'mid_elixir_threshold': 5.354554693159202,
    'late_elixir_threshold': 5.223497137854801,
    'elixir_advantage_threshold': 1.4211914571845607,
    'troop_value_coefficients': {
        'health': 0.03843088645865991,
        'damage': 0.9807446233239183,
        'speed': 1.3534443074209772,
        'attack_range': 0.9132319613228408,
        'splash_range': 1.7825619920427185,
    },
    'deploy_distance': 10.536623353127364,
    'spread_factor': 8.896335265939358,
    'lane_preference': -9.232018101803558,
}
