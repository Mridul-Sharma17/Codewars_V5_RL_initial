...
team_name = "Phase Based 1bfe"
troops = [Troops.barbarian, Troops.archer, Troops.minion, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.giant, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.20378663575163242,
        'elixir_threshold': 8.505076852131651,
        'deploy_distance': 17.09972583330802,
        'troop_preferences': {
            'cheap': 1.6952016097611935,
            'medium': 0.8797750355490354,
            'expensive': 0.6441079772681904,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.37641169082879955,
        'elixir_threshold': 6.208697024721384,
        'deploy_distance': 5.4570577676591805,
        'troop_preferences': {
            'cheap': 1.4947795153933305,
            'medium': 1.718105177368804,
            'expensive': 1.1555163915670184,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.7326140292115537,
        'elixir_threshold': 5.097330741249259,
        'deploy_distance': 4.378903746561842,
        'troop_preferences': {
            'cheap': 0.41192814013455137,
            'medium': 0.9417303532704466,
            'expensive': 1.4080215920760129,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
