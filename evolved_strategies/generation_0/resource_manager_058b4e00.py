...
team_name = "Resource Manager cf99"
troops = [Troops.archer, Troops.knight, Troops.barbarian, Troops.valkyrie, Troops.dragon, Troops.musketeer, Troops.balloon, Troops.giant]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'mid_game_threshold': 97,
    'early_elixir_threshold': 8.859459293729156,
    'mid_elixir_threshold': 6.728170344666131,
    'late_elixir_threshold': 5.061931505780651,
    'elixir_advantage_threshold': 1.3295847572820243,
    'troop_value_coefficients': {
        'health': 0.027482817395425324,
        'damage': 0.5469958204087675,
        'speed': 0.5672723246718543,
        'attack_range': 0.9036725903837453,
        'splash_range': 2.017317790189229,
    },
    'deploy_distance': 6.458940060240694,
    'spread_factor': 9.761118607465004,
    'lane_preference': 13.017821129811864,
}
