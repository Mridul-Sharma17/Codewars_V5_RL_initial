...
deploy_list = Troops([])
team_signal = "v:1,l:a,e:4.2,d:0.7,y:38,t:dwvmk,c:1.7"
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 4.2,  # Minimum elixir to deploy
        "defensive_trigger": 0.6619377634837343,  # Tower health % to switch to defensive
        "y_default": 38,  # Default y position
