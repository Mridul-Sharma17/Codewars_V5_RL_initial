...
team_name = "Lane Adaptor af7a"
troops = [Troops.balloon, Troops.prince, Troops.musketeer, Troops.archer, Troops.dragon, Troops.valkyrie, Troops.barbarian, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 19.13966859252875,
    'lane_memory_factor': 0.6911966534468567,
    'lane_pressure_threshold': 0.7819049096660711,
    'defensive_distance': 10.30855198014762,
    'offensive_distance': 0.051983679266991434,
    'grouping_factor': 0.9752528235913579,
    'counter_deploy_ratio': 0.5466020959913472,
    'troop_role_weights': {
        'tank': 1.8138166713126573,
        'support': 1.3479820075961757,
        'swarm': 0.6739722622835449,
        'splasher': 1.5972878284676746,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
