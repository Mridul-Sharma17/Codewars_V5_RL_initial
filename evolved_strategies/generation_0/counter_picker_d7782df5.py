...
params = {
    'counter_weights': {
        'air': 1.4782140172964806,
        'ground': 0.5837077173766585,
        'splash': 2.630776295913632,
        'tank': 1.9912827912507731,
        'swarm': 1.7452133812316806,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 18.238993385077492,
    'air_deploy_distance': 9.233298046441323,
    'ground_deploy_distance': 14.005277329337936,
    'lane_preference': 16.5928261682772,
    'elixir_threshold': 6.15635241170393,
    'aggressive_threshold': 0.6183526217656662,
}
