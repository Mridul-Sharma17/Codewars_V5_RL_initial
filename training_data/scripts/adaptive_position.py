...
team_name = "AdaptivePosition"
troops = [
    Troops.wizard, Troops.dragon, 
    Troops.musketeer, Troops.knight,
    Troops.valkyrie, Troops.archer, 
    Troops.minion, Troops.barbarian
]
deploy_list = Troops([])
team_signal = "v:1,l:a,e:3.80,s:7.20,dt:0.65,y:40,xl:-25,xr:25,tp:wdmkvamb,ca:1.6,cs:1.6,ct:1.4"

# Strategy parameter constants
MIN_DEPLOY_ELIXIR = 3.8
SAVE_THRESHOLD = 7.2
...
def choose_troop_and_position(my_tower, opp_troops):
    ...
    troop_priorities = ['wizard', 'dragon', 'musketeer', 'knight', 'valkyrie', 'archer', 'minion', 'barbarian']
