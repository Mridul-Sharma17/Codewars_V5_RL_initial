...
team_name = "Phase Based db3f"
troops = [Troops.knight, Troops.minion, Troops.skeleton, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.balloon, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.12238981747707134,
        'elixir_threshold': 8.455509797282645,
        'deploy_distance': 15.324136505939475,
        'troop_preferences': {
            'cheap': 1.754155608062648,
            'medium': 0.7819143240077725,
            'expensive': 0.3162205456762669,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.37012854586618416,
        'elixir_threshold': 4.961668250207917,
        'deploy_distance': 10.833531394245,
        'troop_preferences': {
            'cheap': 0.5495719975947108,
            'medium': 1.786681835635162,
            'expensive': 1.3462225917363688,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.7280386148721625,
        'elixir_threshold': 4.724415301352605,
        'deploy_distance': 3.963177894044386,
        'troop_preferences': {
            'cheap': 0.4914258164420658,
            'medium': 1.1858726203956755,
            'expensive': 1.9331491695728293,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
