...
team_name = "counter_pratyaksh_8a7b6c5d"
troops = [
...
deploy_list = Troops([])
team_signal = "v:1,l:a,e:3.4434505537539404,d:0.4,y:34,t:dwvmk,c:1.5"
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 3.4434505537539404,  # Minimum elixir to deploy
        "defensive_trigger": 0.4148689908214288,  # Tower health % to switch to defensive
        "y_default": 34,  # Default y position
        "y_defensive": 18  # Defensive y position
    }
