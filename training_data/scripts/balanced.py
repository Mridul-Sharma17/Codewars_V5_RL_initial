...
deploy_list = Troops([])
team_signal = "v:1,l:c,e:4.00,s:7.00,dt:0.60,y:40,xl:-20,xr:20,tp:wdkavmmb,ca:1.5,cs:1.7,ct:1.3"
...
def choose_troop_and_position(my_tower, opp_troops):
    ...
    troop_priorities = ['wizard', 'dragon', 'knight', 'archer', 'valkyrie', 'musketeer', 'minion', 'barbarian']
