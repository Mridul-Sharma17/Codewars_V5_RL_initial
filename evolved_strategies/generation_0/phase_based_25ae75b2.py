...
team_name = "Phase Based 8592"
troops = [Troops.knight, Troops.skeleton, Troops.minion, Troops.musketeer, Troops.dragon, Troops.valkyrie, Troops.prince, Troops.balloon]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.3612481766167352,
        'elixir_threshold': 9.73510362754111,
        'deploy_distance': 11.955301073182559,
        'troop_preferences': {
            'cheap': 2.2355095917545045,
            'medium': 1.4632246740507413,
            'expensive': 0.513352270044448,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.4342133801164361,
        'elixir_threshold': 5.344851373609,
        'deploy_distance': 14.473930628109528,
        'troop_preferences': {
            'cheap': 1.1604827282898378,
            'medium': 1.472307055341518,
            'expensive': 0.9050350687834895,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.8476006615983327,
        'elixir_threshold': 3.5347566272876367,
        'deploy_distance': 4.480312491162001,
        'troop_preferences': {
            'cheap': 0.9372751583308783,
            'medium': 0.83627365619305,
            'expensive': 1.043161925579411,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
