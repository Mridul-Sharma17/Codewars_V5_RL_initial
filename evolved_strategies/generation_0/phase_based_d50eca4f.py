...
team_name = "Phase Based a397"
troops = [Troops.archer, Troops.skeleton, Troops.knight, Troops.valkyrie, Troops.dragon, Troops.musketeer, Troops.balloon, Troops.giant]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.30103488661972183,
        'elixir_threshold': 7.069123420823798,
        'deploy_distance': 15.060597953750742,
        'troop_preferences': {
            'cheap': 1.0021730967590672,
            'medium': 0.8399165888756583,
            'expensive': 0.42416126208108496,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.5511559092264271,
        'elixir_threshold': 4.284789367837449,
        'deploy_distance': 11.130819542709249,
        'troop_preferences': {
            'cheap': 1.3406690421110194,
            'medium': 1.14785185035,
            'expensive': 1.1453178129386292,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.935919665929196,
        'elixir_threshold': 2.918080391885752,
        'deploy_distance': 1.4501926924327302,
        'troop_preferences': {
            'cheap': 0.7507184177059385,
            'medium': 1.1098194226887386,
            'expensive': 1.6752058988862562,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
