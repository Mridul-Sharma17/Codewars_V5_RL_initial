...
params = {
    'counter_weights': {
        'air': 2.9720486507760717,
        'ground': 2.3788352773639367,
        'splash': 2.917056820581371,
        'tank': 2.1717765329938565,
        'swarm': 2.834210357174239,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 11.9590747628096,
    'air_deploy_distance': 5.445322917718414,
    'ground_deploy_distance': 13.513102621654198,
    'lane_preference': 10.133445626123127,
    'elixir_threshold': 7.531645532171437,
    'aggressive_threshold': 0.6286897616269884,
}
