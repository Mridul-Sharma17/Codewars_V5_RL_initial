...
team_name = "Aggressive"
troops = [
    Troops.dragon, Troops.wizard, 
    Troops.valkyrie, Troops.prince,
    Troops.knight, Troops.musketeer, 
    Troops.archer, Troops.barbarian
]
deploy_list = Troops([])
team_signal = "v:1,l:r,e:3.00,s:6.00,dt:0.50,y:45,xl:-18,xr:18,tp:dwvpkmab,ca:1.8,cs:1.5,ct:1.2"

# Strategy parameter constants
MIN_DEPLOY_ELIXIR = 3.0
SAVE_THRESHOLD = 6.0
DEFENSIVE_TRIGGER = 0.5
Y_DEFAULT = 45
Y_DEFENSIVE = 25
X_MIN = -18
X_MAX = 18
...
def choose_troop_and_position(my_tower, opp_troops):
    ...
    troop_priorities = ['dragon', 'wizard', 'valkyrie', 'prince', 'knight', 'musketeer', 'archer', 'barbarian']
