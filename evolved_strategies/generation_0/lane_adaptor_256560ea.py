...
team_name = "Lane Adaptor b812"
troops = [Troops.giant, Troops.balloon, Troops.musketeer, Troops.archer, Troops.wizard, Troops.valkyrie, Troops.skeleton, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 12.636807051523949,
    'lane_memory_factor': 0.6560636299055189,
    'lane_pressure_threshold': 0.6675789752112965,
    'defensive_distance': 10.065601095224574,
    'offensive_distance': 8.481454589606832,
    'grouping_factor': 0.3723388636229513,
    'counter_deploy_ratio': 0.9174895662381292,
    'troop_role_weights': {
        'tank': 1.119343780421455,
        'support': 1.041042939936935,
        'swarm': 1.263772243545338,
        'splasher': 1.523604889544882,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
