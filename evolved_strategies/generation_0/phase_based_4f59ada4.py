...
team_name = "Phase Based 5428"
troops = [Troops.archer, Troops.barbarian, Troops.minion, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.balloon, Troops.wizard]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.3969214679810056,
        'elixir_threshold': 9.529160234731606,
        'deploy_distance': 15.67558354872979,
        'troop_preferences': {
            'cheap': 1.3341716179726488,
            'medium': 0.5655739643096024,
            'expensive': 0.7042068289072325,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.6427667898421026,
        'elixir_threshold': 6.936829438261629,
        'deploy_distance': 13.017355596331022,
        'troop_preferences': {
            'cheap': 1.0865742006624644,
            'medium': 1.4456411712175417,
            'expensive': 0.8116917751367667,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.9223570128344346,
        'elixir_threshold': 5.522802622642651,
        'deploy_distance': 7.880372526747434,
        'troop_preferences': {
            'cheap': 0.27307921537131796,
            'medium': 0.8773231634462202,
            'expensive': 1.976431767592986,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
