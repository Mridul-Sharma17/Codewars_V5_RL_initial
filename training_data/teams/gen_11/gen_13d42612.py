...
deploy_list = Troops([])
team_signal = "v:1,l:c,e:3,d:0.7,y:44,t:dwmva,c:1.5"

def random_x(min_val=-25, max_val=20):
...
def parse_signal(signal):
    ...
    params = {
        ...
        "defensive_trigger": 0.7186559145252767,  # Tower health % to switch to defensive
