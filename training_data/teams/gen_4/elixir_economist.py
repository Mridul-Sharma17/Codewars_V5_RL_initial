...
deploy_list = Troops([])
team_signal = "v:1,l:b,e:5.0,d:0.6,y:35,t:akmwv,c:1.4"
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 5.0,  # Minimum elixir to deploy
        "defensive_trigger": 0.6,  # Tower health % to switch to defensive
        "y_default": 35,  # Default y position
        "y_defensive": 17  # Defensive y position
    }
