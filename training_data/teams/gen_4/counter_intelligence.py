...
team_name = "counter_intelligence"
troops = [
...
deploy_list = Troops([])
team_signal = "v:1,l:a,e:4.0,d:0.7,y:32,t:dwmvk,c:1.6"

def random_x(min_val=-28, max_val=28):
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 4.0,  # Minimum elixir to deploy
        "defensive_trigger": 0.7,  # Tower health % to switch to defensive
        "y_default": 32,  # Default y position
        "y_defensive": 16  # Defensive y position
    }
