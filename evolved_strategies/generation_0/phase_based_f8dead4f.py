...
team_name = "Phase Based 6590"
troops = [Troops.archer, Troops.minion, Troops.barbarian, Troops.valkyrie, Troops.musketeer, Troops.dragon, Troops.wizard, Troops.giant]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.12610068695278814,
        'elixir_threshold': 7.486821087197859,
        'deploy_distance': 10.359694182027434,
        'troop_preferences': {
            'cheap': 1.6788067905683406,
            'medium': 1.4201226701183354,
            'expensive': 0.3368472545200982,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.7508586059632403,
        'elixir_threshold': 6.026693834262456,
        'deploy_distance': 8.503736546055535,
        'troop_preferences': {
            'cheap': 1.4555246396313692,
            'medium': 1.3283224266466647,
            'expensive': 1.203523148976846,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.9878025771647279,
        'elixir_threshold': 5.738149505269172,
        'deploy_distance': 4.945425922741143,
        'troop_preferences': {
            'cheap': 0.769143143986948,
            'medium': 1.1521148043072675,
            'expensive': 1.5639435104857404,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
