...
team_name = "Resource Manager be39"
troops = [Troops.barbarian, Troops.archer, Troops.skeleton, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.prince, Troops.wizard]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 34,
    'mid_game_threshold': 119,
    'early_elixir_threshold': 5.935439155700415,
    'mid_elixir_threshold': 6.664446004867841,
    'late_elixir_threshold': 6.8269597514205635,
    'elixir_advantage_threshold': 1.7679591729969457,
    'troop_value_coefficients': {
        'health': 0.07625217948697523,
        'damage': 0.9711329578853446,
        'speed': 1.1966578092816285,
        'attack_range': 0.3397460519749629,
        'splash_range': 1.4985151192963742,
    },
    'deploy_distance': 15.863683519044113,
    'spread_factor': 15.779171885123978,
    'lane_preference': 11.117384372327422,
}
