...
team_name = "Resource Manager 521d"
troops = [Troops.skeleton, Troops.knight, Troops.barbarian, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.wizard, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'mid_game_threshold': 108,
    'early_elixir_threshold': 5.394608279608423,
    'mid_elixir_threshold': 5.15766034814396,
    'late_elixir_threshold': 4.7906501574852705,
    'elixir_advantage_threshold': 2.346164124071186,
    'troop_value_coefficients': {
        'health': 0.08393879892159574,
        'damage': 0.8006945562972889,
        'speed': 0.9086826313869388,
        'attack_range': 0.3732478588880221,
        'splash_range': 2.3003600287697683,
    },
    'deploy_distance': 9.48748624109922,
    'spread_factor': 18.527031977671896,
    'lane_preference': 17.69798642917445,
}
