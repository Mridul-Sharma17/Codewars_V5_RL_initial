...
deploy_list = Troops([])
team_signal = "v:1,l:a,e:3.8,d:0.6,y:36,t:dwmvk,c:1.5"

def random_x(min_val=-24, max_val=24):
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 3.8,  # Minimum elixir to deploy
        "defensive_trigger": 0.6,  # Tower health % to switch to defensive
        "y_default": 36,  # Default y position
