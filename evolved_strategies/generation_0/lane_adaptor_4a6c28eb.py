...
team_name = "Lane Adaptor c864"
troops = [Troops.balloon, Troops.prince, Troops.archer, Troops.musketeer, Troops.dragon, Troops.wizard, Troops.barbarian, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 14.091766861767134,
    'lane_memory_factor': 0.8628949355875576,
    'lane_pressure_threshold': 0.5960960185256721,
    'defensive_distance': 13.098782722685183,
    'offensive_distance': 3.4214493398741097,
    'grouping_factor': 0.7362846379549907,
    'counter_deploy_ratio': 0.6137159903710816,
    'troop_role_weights': {
        'tank': 1.623335113062898,
        'support': 0.8527402376912347,
        'swarm': 0.7939920683387747,
        'splasher': 1.9693327956343158,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
