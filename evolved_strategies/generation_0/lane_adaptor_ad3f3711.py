...
team_name = "Lane Adaptor b882"
troops = [Troops.knight, Troops.prince, Troops.archer, Troops.musketeer, Troops.dragon, Troops.wizard, Troops.skeleton, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 21.34272652946848,
    'lane_memory_factor': 0.8936872766704558,
    'lane_pressure_threshold': 0.6645328517169427,
    'defensive_distance': 15.143408070852518,
    'offensive_distance': 8.53165812561338,
    'grouping_factor': 0.8162926090455813,
    'counter_deploy_ratio': 1.354487219100327,
    'troop_role_weights': {
        'tank': 1.21212751024728,
        'support': 1.5397095419880944,
        'swarm': 0.9194777279461922,
        'splasher': 1.4235204158434278,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
