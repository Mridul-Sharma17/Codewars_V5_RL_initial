# Modified import statement to work with our directory structure
from game import Game  # This will use the local game.py file
import inspect
...
def validate_module(module, name):
    ...
    try:
        ...
        print(f"Error validating module {name}: {e}")
        return False
