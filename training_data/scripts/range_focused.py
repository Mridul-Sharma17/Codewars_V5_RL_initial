...
team_name = "RangeFocused"
troops = [
    Troops.wizard, Troops.musketeer, 
    Troops.archer, Troops.dragon,
    Troops.minion, Troops.knight, 
    Troops.valkyrie, Troops.barbarian
]
deploy_list = Troops([])
team_signal = "v:1,l:c,e:4.00,s:7.00,dt:0.70,y:35,xl:-15,xr:15,tp:wmadmkvb,ca:1.5,cs:1.7,ct:1.0"

# Strategy parameter constants
MIN_DEPLOY_ELIXIR = 4.0
SAVE_THRESHOLD = 7.0
...
def choose_troop_and_position(my_tower, opp_troops):
    ...
    troop_priorities = ['wizard', 'musketeer', 'archer', 'dragon', 'minion', 'knight', 'valkyrie', 'barbarian']
