...
team_name = "Resource Manager 4a12"
troops = [Troops.skeleton, Troops.barbarian, Troops.archer, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.wizard, Troops.giant]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 60,
    'mid_game_threshold': 112,
    'early_elixir_threshold': 7.985293286418685,
    'mid_elixir_threshold': 5.4863893849351655,
    'late_elixir_threshold': 3.867988618519333,
    'elixir_advantage_threshold': 2.829707589225565,
    'troop_value_coefficients': {
        'health': 0.09295707396748763,
        'damage': 0.23191551444952957,
        'speed': 1.814867219037778,
        'attack_range': 0.9459615189839512,
        'splash_range': 1.9737243079712918,
    },
    'deploy_distance': 16.175319711201567,
    'spread_factor': 7.123233980174968,
    'lane_preference': 2.2132146883573185,
}
