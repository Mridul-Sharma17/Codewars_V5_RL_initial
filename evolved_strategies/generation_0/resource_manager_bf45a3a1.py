...
team_name = "Resource Manager 8676"
troops = [Troops.archer, Troops.knight, Troops.minion, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.wizard, Troops.giant]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_elixir_threshold': 6.9949437150677145,
    'mid_elixir_threshold': 6.999682596103836,
    'late_elixir_threshold': 4.2293699631128625,
    'elixir_advantage_threshold': 1.8179006129944537,
    'troop_value_coefficients': {
        'health': 0.024640185141628308,
        'damage': 0.5999828110769159,
        'speed': 0.9772182465465414,
        'attack_range': 0.9118317233251949,
        'splash_range': 2.024697295202497,
    },
    'deploy_distance': 10.456338413486048,
    'spread_factor': 11.09589970592469,
    'lane_preference': -1.8776528502762524,
}
