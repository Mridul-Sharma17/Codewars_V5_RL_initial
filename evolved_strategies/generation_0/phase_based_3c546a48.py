...
team_name = "Phase Based 80e5"
troops = [Troops.knight, Troops.minion, Troops.skeleton, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.balloon, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.26395975115741377,
        'elixir_threshold': 7.321470701353291,
        'deploy_distance': 11.287106677267477,
        'troop_preferences': {
            'cheap': 1.9727810953899327,
            'medium': 0.795300274255001,
            'expensive': 0.4305116046177697,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.3794049207701522,
        'elixir_threshold': 6.63499778224715,
        'deploy_distance': 13.365144937212223,
        'troop_preferences': {
            'cheap': 1.1289776535654257,
            'medium': 1.685202489715797,
            'expensive': 1.2026666718158086,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.8785886597857508,
        'elixir_threshold': 4.283027582422834,
        'deploy_distance': 2.128393321763349,
        'troop_preferences': {
            'cheap': 0.7114911227969138,
            'medium': 1.3629265180611183,
            'expensive': 1.9066626237901705,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
