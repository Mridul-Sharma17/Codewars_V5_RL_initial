...
params = {
    'counter_weights': {
        'air': 1.602375969348942,
        'ground': 1.8166750995431495,
        'splash': 1.8314527017373758,
        'tank': 1.6925275765815586,
        'swarm': 2.3337358058685904,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 18.881397353432895,
    'air_deploy_distance': 0.8051797491377599,
    'ground_deploy_distance': 11.269174280225274,
    'lane_preference': 1.7385138283708415,
    'elixir_threshold': 5.169019178981045,
    'aggressive_threshold': 0.5457906483985073,
}
