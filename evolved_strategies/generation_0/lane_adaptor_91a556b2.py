...
team_name = "Lane Adaptor 1dfa"
troops = [Troops.balloon, Troops.prince, Troops.musketeer, Troops.archer, Troops.valkyrie, Troops.dragon, Troops.skeleton, Troops.barbarian]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 12.12578980535441,
    'lane_memory_factor': 0.8929375910425248,
    'lane_pressure_threshold': 0.6860781917740557,
    'defensive_distance': 19.071497702865024,
    'offensive_distance': 6.828197553104694,
    'grouping_factor': 0.7713617532974347,
    'counter_deploy_ratio': 0.7899704102748437,
    'troop_role_weights': {
        'tank': 1.3712870489885458,
        'support': 0.9853630781355773,
        'swarm': 1.2545839638512688,
        'splasher': 1.2355128259864128,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
