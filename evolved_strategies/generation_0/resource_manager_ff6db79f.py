...
team_name = "Resource Manager 7226"
troops = [Troops.barbarian, Troops.skeleton, Troops.archer, Troops.valkyrie, Troops.musketeer, Troops.dragon, Troops.giant, Troops.balloon]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 46,
    'mid_game_threshold': 91,
    'early_elixir_threshold': 8.195124059260216,
    'mid_elixir_threshold': 5.635175329518812,
    'late_elixir_threshold': 5.628042782254891,
    'elixir_advantage_threshold': 2.6226606935463233,
    'troop_value_coefficients': {
        'health': 0.04139957142342607,
        'damage': 0.857021459372479,
        'speed': 1.0183518986373254,
        'attack_range': 0.269355508552858,
        'splash_range': 2.3316107535990023,
    },
    'deploy_distance': 11.028884719958004,
    'spread_factor': 10.956650910587108,
    'lane_preference': 5.4623640540932925,
}
