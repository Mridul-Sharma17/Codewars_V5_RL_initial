...
team_name = "Lane Adaptor c5f3"
troops = [Troops.prince, Troops.balloon, Troops.musketeer, Troops.archer, Troops.wizard, Troops.valkyrie, Troops.minion, Troops.barbarian]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 15.406258679314519,
    'lane_memory_factor': 0.7497681247610157,
    'lane_pressure_threshold': 0.7052916451294575,
    'defensive_distance': 18.44774699428251,
    'offensive_distance': 5.029450098366138,
    'grouping_factor': 0.9943512851344706,
    'counter_deploy_ratio': 1.1015700146024316,
    'troop_role_weights': {
        'tank': 1.3118200803590803,
        'support': 1.9606404372140394,
        'swarm': 1.535725849165751,
        'splasher': 0.6296387424651606,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
