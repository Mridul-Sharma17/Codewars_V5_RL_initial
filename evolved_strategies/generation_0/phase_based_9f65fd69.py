...
team_name = "Phase Based 0158"
troops = [Troops.archer, Troops.skeleton, Troops.barbarian, Troops.valkyrie, Troops.musketeer, Troops.dragon, Troops.giant, Troops.wizard]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.4541732565582902,
        'elixir_threshold': 7.625701225890765,
        'deploy_distance': 19.390951315035643,
        'troop_preferences': {
            'cheap': 1.0329826072947217,
            'medium': 1.2359493964173516,
            'expensive': 0.5015505577799189,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.49820684546846555,
        'elixir_threshold': 7.364495025676369,
        'deploy_distance': 11.05775434599198,
        'troop_preferences': {
            'cheap': 1.0917749047464005,
            'medium': 1.5691391571682742,
            'expensive': 1.0284413340167502,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.9518647255223778,
        'elixir_threshold': 4.661792730324952,
        'deploy_distance': 5.907716457064737,
        'troop_preferences': {
            'cheap': 0.9196110008738725,
            'medium': 1.4375760453073232,
            'expensive': 1.1906426025776204,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
