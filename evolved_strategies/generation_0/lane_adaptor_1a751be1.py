...
team_name = "Lane Adaptor de5c"
troops = [Troops.knight, Troops.giant, Troops.musketeer, Troops.archer, Troops.dragon, Troops.valkyrie, Troops.skeleton, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 17.59344658090209,
    'lane_memory_factor': 0.8246277507786216,
    'lane_pressure_threshold': 0.42752531190442533,
    'defensive_distance': 17.80975966698151,
    'offensive_distance': 7.085478591453114,
    'grouping_factor': 0.05002305674765317,
    'counter_deploy_ratio': 0.6225850072709119,
    'troop_role_weights': {
        'tank': 0.8257233726689512,
        'support': 1.7450052412121415,
        'swarm': 0.9094491045537291,
        'splasher': 1.083801796662949,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
