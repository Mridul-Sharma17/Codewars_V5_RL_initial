...
deploy_list = Troops([])
team_signal = "v:1,l:s,e:4.8,d:0.5,y:42,t:dmwmv,c:2.2"

def random_x(min_val=-22, max_val=22):
...
def parse_signal(signal):
    ...
    params = {
        ...
        "min_elixir": 4.8,  # Minimum elixir to deploy
        "defensive_trigger": 0.5,  # Tower health % to switch to defensive
        "y_default": 42,  # Default y position
