...
team_name = "Phase Based 7960"
troops = [Troops.barbarian, Troops.minion, Troops.knight, Troops.valkyrie, Troops.musketeer, Troops.dragon, Troops.balloon, Troops.prince]
deploy_list = Troops([])
team_signal = ""
...
params = {
    ...
    'early_phase_strategy': {
        'aggression': 0.0936937120283523,
        'elixir_threshold': 6.550653170890569,
        'deploy_distance': 16.502626905636046,
        'troop_preferences': {
            'cheap': 1.8547521559812914,
            'medium': 1.4165764521079272,
            'expensive': 0.757831267120884,
        },
    },
    'mid_phase_strategy': {
        'aggression': 0.6725909197519409,
        'elixir_threshold': 6.601696710450383,
        'deploy_distance': 8.171142844260958,
        'troop_preferences': {
            'cheap': 1.1016098395612777,
            'medium': 1.076180045911645,
            'expensive': 1.2206011619148278,
        },
    },
    'late_phase_strategy': {
        'aggression': 0.7428618286950622,
        'elixir_threshold': 2.605017764854533,
        'deploy_distance': 2.1286164408803687,
        'troop_preferences': {
            'cheap': 0.3490105813874721,
            'medium': 1.3931592735558584,
            'expensive': 1.300324053262912,
        },
    },
    'troop_costs': {
        'Archer': 'cheap',
