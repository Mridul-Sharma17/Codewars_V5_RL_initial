...
team_name = "Resource Manager 9786"
troops = [Troops.minion, Troops.archer, Troops.barbarian, Troops.musketeer, Troops.dragon, Troops.valkyrie, Troops.balloon, Troops.prince]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 56,
    'mid_game_threshold': 92,
    'early_elixir_threshold': 5.117241406028895,
    'mid_elixir_threshold': 4.143713999542696,
    'late_elixir_threshold': 3.7604768818995775,
    'elixir_advantage_threshold': 1.8880288567670258,
    'troop_value_coefficients': {
        'health': 0.042161774085250285,
        'damage': 0.5385440987327574,
        'speed': 1.2919415803334893,
        'attack_range': 0.8953459453852224,
        'splash_range': 1.9347860251535425,
    },
    'deploy_distance': 6.917171075293685,
    'spread_factor': 14.584049938931987,
    'lane_preference': 16.505370793943598,
}
