...
team_name = "Resource Manager e800"
troops = [Troops.barbarian, Troops.archer, Troops.knight, Troops.dragon, Troops.musketeer, Troops.valkyrie, Troops.wizard, Troops.prince]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 58,
    'mid_game_threshold': 113,
    'early_elixir_threshold': 7.993682401989258,
    'mid_elixir_threshold': 6.932562172086943,
    'late_elixir_threshold': 3.0941592953673487,
    'elixir_advantage_threshold': 1.061111019066697,
    'troop_value_coefficients': {
        'health': 0.03704769821384671,
        'damage': 0.6059741663467251,
        'speed': 1.3090983549557513,
        'attack_range': 0.24355799335391692,
        'splash_range': 1.113471845215021,
    },
    'deploy_distance': 15.781328293205856,
    'spread_factor': 6.691551861505997,
    'lane_preference': -6.316428081689121,
}
