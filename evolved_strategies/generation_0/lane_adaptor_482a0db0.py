...
team_name = "Lane Adaptor f465"
troops = [Troops.giant, Troops.knight, Troops.musketeer, Troops.archer, Troops.valkyrie, Troops.dragon, Troops.barbarian, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 16.903202934570253,
    'lane_memory_factor': 0.8824646300009698,
    'lane_pressure_threshold': 0.7537363928864039,
    'defensive_distance': 13.947909305107206,
    'offensive_distance': 8.268892913868287,
    'grouping_factor': 0.44587745471010654,
    'counter_deploy_ratio': 1.039799781784319,
    'troop_role_weights': {
        'tank': 1.1569907432633513,
        'support': 1.7029983271419524,
        'swarm': 0.5774897228960982,
        'splasher': 1.3611716416303634,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
