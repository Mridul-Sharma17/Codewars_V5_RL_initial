...
team_name = "Resource Manager 6c62"
troops = [Troops.archer, Troops.knight, Troops.skeleton, Troops.musketeer, Troops.valkyrie, Troops.dragon, Troops.prince, Troops.balloon]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 37,
    'mid_game_threshold': 96,
    'early_elixir_threshold': 7.628940390569811,
    'mid_elixir_threshold': 6.991683791640764,
    'late_elixir_threshold': 4.2234126829323735,
    'elixir_advantage_threshold': 1.0781681340257652,
    'troop_value_coefficients': {
        'health': 0.0857140120429648,
        'damage': 0.8393233905222752,
        'speed': 0.6626528026136314,
        'attack_range': 0.5124454129601925,
        'splash_range': 2.60546686144525,
    },
    'deploy_distance': 10.426295646735994,
    'spread_factor': 15.246090623400645,
    'lane_preference': -16.86627647461134,
}
