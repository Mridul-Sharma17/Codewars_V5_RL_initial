...
team_name = "Lane Adaptor 2191"
troops = [Troops.knight, Troops.balloon, Troops.archer, Troops.musketeer, Troops.wizard, Troops.valkyrie, Troops.skeleton, Troops.minion]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 11.151099407270792,
    'lane_memory_factor': 0.6022367058823792,
    'lane_pressure_threshold': 0.7626678218459245,
    'defensive_distance': 17.071375653318505,
    'offensive_distance': 1.03773011605925,
    'grouping_factor': 0.3477982616183458,
    'counter_deploy_ratio': 1.4774511920699431,
    'troop_role_weights': {
        'tank': 0.8658335332544544,
        'support': 1.406305097543638,
        'swarm': 0.5411687276109052,
        'splasher': 0.8276631226880564,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
