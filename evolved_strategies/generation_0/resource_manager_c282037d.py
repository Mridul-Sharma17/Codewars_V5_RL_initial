...
team_name = "Resource Manager dd85"
troops = [Troops.barbarian, Troops.minion, Troops.skeleton, Troops.musketeer, Troops.dragon, Troops.valkyrie, Troops.giant, Troops.wizard]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 33,
    'mid_game_threshold': 110,
    'early_elixir_threshold': 5.512871916136036,
    'mid_elixir_threshold': 7.868396801308727,
    'late_elixir_threshold': 6.468302927976902,
    'elixir_advantage_threshold': 1.7028367193468952,
    'troop_value_coefficients': {
        'health': 0.05789080747404041,
        'damage': 0.41180364294191163,
        'speed': 0.5227285163681767,
        'attack_range': 0.5300319129153902,
        'splash_range': 1.2338319648546672,
    },
    'deploy_distance': 9.497639041671087,
    'spread_factor': 15.532263413216425,
    'lane_preference': 15.029449887312303,
}
