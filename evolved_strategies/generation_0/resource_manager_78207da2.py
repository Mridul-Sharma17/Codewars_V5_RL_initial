...
team_name = "Resource Manager cf79"
troops = [Troops.skeleton, Troops.barbarian, Troops.knight, Troops.valkyrie, Troops.dragon, Troops.musketeer, Troops.giant, Troops.prince]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 47,
    'mid_game_threshold': 104,
    'early_elixir_threshold': 7.8714686276296515,
    'mid_elixir_threshold': 7.176370442792436,
    'late_elixir_threshold': 6.782665906283718,
    'elixir_advantage_threshold': 1.3960556359772485,
    'troop_value_coefficients': {
        'health': 0.05827752960035999,
        'damage': 0.5448751194777004,
        'speed': 1.6206505688789696,
        'attack_range': 0.8881500043507164,
        'splash_range': 2.7984349890831526,
    },
    'deploy_distance': 19.79647143646743,
    'spread_factor': 12.401403982640016,
    'lane_preference': 10.719868662106169,
}
