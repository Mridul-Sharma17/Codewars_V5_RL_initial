...
params = {
    'counter_weights': {
        'air': 1.9792651084330188,
        'ground': 1.3118142952993472,
        'splash': 1.802215911760831,
        'tank': 2.553137038573528,
        'swarm': 2.1510410389988475,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 16.350714461585774,
    'air_deploy_distance': 1.0708787300220002,
    'ground_deploy_distance': 0.866691361608462,
    'lane_preference': -3.9334273866870575,
    'elixir_threshold': 7.997084479579994,
    'aggressive_threshold': 0.5645511533243031,
}
