...
deploy_list = Troops([])
team_signal = "v:1,l:a,e:3.50,s:7.00,dt:0.65,y:38,xl:-20,xr:20,tp:wmadkvmb,ca:2.5,cs:1.8,ct:1.0"
...
def choose_troop_and_position(my_tower, opp_troops):
    ...
    troop_priorities = ['wizard', 'musketeer', 'archer', 'dragon', 'knight', 'valkyrie', 'minion', 'barbarian']
