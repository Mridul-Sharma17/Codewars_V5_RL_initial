...
params = {
    'counter_weights': {
        'air': 0.7957933675496096,
        'ground': 1.0354396385887026,
        'splash': 1.3554255716281143,
        'tank': 2.6723236966025694,
        'swarm': 0.8292560444455863,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 19.582986656180324,
    'air_deploy_distance': 8.874579493773687,
    'ground_deploy_distance': 14.200871876906637,
    'lane_preference': 2.490224151983462,
    'elixir_threshold': 6.082253694377341,
    'aggressive_threshold': 0.3442750807722223,
}
