...
team_name = "Lane Adaptor 7ad2"
troops = [Troops.balloon, Troops.knight, Troops.archer, Troops.musketeer, Troops.dragon, Troops.valkyrie, Troops.minion, Troops.skeleton]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 22.759444265676713,
    'lane_memory_factor': 0.7321765981736927,
    'lane_pressure_threshold': 0.6204614526932133,
    'defensive_distance': 13.002742899196214,
    'offensive_distance': 4.064320526073237,
    'grouping_factor': 0.19039665134296602,
    'counter_deploy_ratio': 0.559578834555635,
    'troop_role_weights': {
        'tank': 1.3561955754070394,
        'support': 1.465552693766205,
        'swarm': 0.6719287539912324,
        'splasher': 1.7457018238188076,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
