...
params = {
    'counter_weights': {
        'air': 1.370557564434395,
        'ground': 1.2606001955596289,
        'splash': 2.686738050720147,
        'tank': 2.790059330239827,
        'swarm': 0.5556748819276526,
    },
    'troop_to_category': {
    ...
    'deploy_distance': 7.219260644303866,
    'air_deploy_distance': 7.410548591623584,
    'ground_deploy_distance': 14.977895951131023,
    'lane_preference': 17.220980687005117,
    'elixir_threshold': 6.732864426039608,
    'aggressive_threshold': 0.6622824152728028,
}
