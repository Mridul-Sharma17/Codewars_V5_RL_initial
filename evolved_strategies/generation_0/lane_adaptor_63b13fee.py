...
team_name = "Lane Adaptor 085a"
troops = [Troops.knight, Troops.balloon, Troops.archer, Troops.musketeer, Troops.dragon, Troops.valkyrie, Troops.skeleton, Troops.barbarian]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 21.30081634240844,
    'lane_memory_factor': 0.6857018293928816,
    'lane_pressure_threshold': 0.7088111485922794,
    'defensive_distance': 18.453495929355128,
    'offensive_distance': 7.007842746169509,
    'grouping_factor': 0.05872136460220112,
    'counter_deploy_ratio': 0.7875993954916397,
    'troop_role_weights': {
        'tank': 1.6999503909085363,
        'support': 1.6877403458110676,
        'swarm': 0.8771451807477079,
        'splasher': 0.8789748824362138,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
