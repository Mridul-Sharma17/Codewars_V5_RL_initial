...
team_name = "Lane Adaptor 4558"
troops = [Troops.prince, Troops.giant, Troops.archer, Troops.musketeer, Troops.dragon, Troops.wizard, Troops.minion, Troops.barbarian]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'lane_width': 16.129422178370973,
    'lane_memory_factor': 0.664611383408631,
    'lane_pressure_threshold': 0.4395125847920691,
    'defensive_distance': 12.855243906691728,
    'offensive_distance': 1.2789519345496236,
    'grouping_factor': 0.7215026584693062,
    'counter_deploy_ratio': 0.725991948147406,
    'troop_role_weights': {
        'tank': 1.2284634409113966,
        'support': 0.9420322235042191,
        'swarm': 1.0451150531271634,
        'splasher': 1.2020376516002207,
    },
    'troop_roles': {
        'Giant': 'tank',
        'Knight': 'tank',
