...
team_name = "Resource Manager a16a"
troops = [Troops.minion, Troops.skeleton, Troops.barbarian, Troops.dragon, Troops.valkyrie, Troops.musketeer, Troops.prince, Troops.giant]
deploy_list = Troops([])
team_signal = ""

# Strategy parameters
params = {
    'early_game_threshold': 35,
    'mid_game_threshold': 113,
    'early_elixir_threshold': 6.850549161709022,
    'mid_elixir_threshold': 4.111539011008701,
    'late_elixir_threshold': 4.939935708452791,
    'elixir_advantage_threshold': 2.0221070524335465,
    'troop_value_coefficients': {
        'health': 0.07762446316595524,
        'damage': 0.2776853755192167,
        'speed': 1.7113788467779818,
        'attack_range': 0.8201539987711168,
        'splash_range': 1.3589939076598596,
    },
    'deploy_distance': 17.682676309634736,
    'spread_factor': 18.381863000764756,
    'lane_preference': -9.025540522225723,
}
